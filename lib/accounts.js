module.exports = (zuoraClient) => {
  ...
  const update = (accountId, body) => zuoraClient.http.put(`/object/account/${accountId}`, body);

  const updateRest = (accountId, body) => zuoraClient.http.put(`/accounts/${accountId}`, body);
